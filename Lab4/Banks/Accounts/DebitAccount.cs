...
{
    public DebitAccount(int id, Client client, Bank bank, BankTariff bankTariff, DebitAccountDataInitializer debitAccountDataInitializer)
        : base(id, client, bank, bankTariff, debitAccountDataInitializer)
    { }
    ...
    public override decimal CalculateInterest(DateTime dateTo)
    {
        ...
        decimal dailyInterestRate = BankTariff.DebitInterestRate / 365;
